...
interface PassengerPaymentProps {
  ...
  setExtraBaggageKg: (kg: number) => void
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right pl-4 border-l border-slate-200">
            ...
            <span className="text-xl font-black text-orange-600">
              {formatMoney(holdResult?.price || (Number(flight.currentPrice || flight.basePrice) + extraBaggageKg * 1000))}
            </span>
          </div>
        </div>
      </div>
      ...
      {!holdResult && (
        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm space-y-6">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
            ...
            <h3 className="text-lg font-bold text-slate-900">Thông tin hành khách & Hành lý</h3>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-semibold mt-1">
                💼 Phí hành lý ký gửi: <strong className="text-orange-600">{formatMoney(extraBaggageKg * 1000)}</strong>
              </p>
            </div>
      ...
      {holdResult && (
        <div className="space-y-6">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-3xl p-6 text-emerald-900 space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs font-semibold pt-2 border-t border-emerald-200/60">
              <div>
              ...
              <div>
                <span className="text-emerald-600 block">Hành lý ký gửi:</span>
                <strong className="text-sm text-slate-900">{holdResult.baggageWeightKg ?? 0} kg ({formatMoney(holdResult.baggageFee ?? 0)})</strong>
              </div>
              <div>
