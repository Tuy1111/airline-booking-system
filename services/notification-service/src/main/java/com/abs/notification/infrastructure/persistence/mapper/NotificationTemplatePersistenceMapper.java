...
public final class NotificationTemplatePersistenceMapper {
    ...
    public static NotificationTemplateAggregate toAggregate(NotificationTemplateEntity entity) {
        return NotificationTemplateAggregate.builder()
                .code(entity.getCode())
    ...
    public static NotificationTemplateEntity toEntity(NotificationTemplateAggregate aggregate) {
